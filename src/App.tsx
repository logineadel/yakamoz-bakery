...
const PRODUCTS: Product[] = [
  {
    ...
    description: "Golden, buttery cookie loaded with semi-sweet chocolate chips. Crisp edges, chewy center.",
    price: 45,
    image: "https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600&h=600&fit=crop&auto=format",
    tag: "Bestseller",
  },
  {
    id: 2,
    name: "Double Fudge Brownie",
    description: "Intensely chocolatey, dense brownie with a shiny crinkle top. A pure indulgence.",
    price: 55,
  ...
  },
  {
    ...
    description: "Soft, pillowy red velvet cookie swirled with cream cheese chips. Rich and tangy.",
    price: 50,
    image: "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=600&h=600&fit=crop&auto=format",
    tag: "New",
  },
  {
    id: 4,
    name: "Nutella Brownie",
    description: "Fudgy brownie marbled with ribbons of Nutella. Hazelnut heaven in every bite.",
    price: 65,
  ...
  },
  {
    ...
    description: "Thick cookie wrapped around a whole Oreo. Two beloved classics, one perfect bite.",
    price: 60,
    image: "https://images.unsplash.com/photo-1617305855058-336d24456869?w=600&h=600&fit=crop&auto=format",
    tag: "Popular",
  },
  {
    id: 6,
    name: "Salted Caramel Brownie",
    description: "Fudgy brownie drizzled with house-made caramel and flaky sea salt. Sweet meets salty.",
    price: 70,
    image: "https://images.unsplash.com/photo-1564355808539-22fda35bed7e?w=600&h=600&fit=crop&auto=format",
    tag: "Premium",
  },
  {
    id: 7,
    name: "Peanut Butter Cookie",
    description: "Crumbly, rich peanut butter cookie with a classic crosshatch press. Deeply nutty.",
    price: 45,
    image: "https://images.unsplash.com/photo-1548365328-8c6db3220f4f?w=600&h=600&fit=crop&auto=format",
    tag: "Classic",
  },
  {
    id: 8,
    name: "White Chocolate Blondie",
    description: "Butterscotch-forward blondie studded with white chocolate chunks and toasted pecans.",
    price: 60,
    image: "https://images.unsplash.com/photo-1627308595229-7830a5c18107?w=600&h=600&fit=crop&auto=format",
    tag: "New",
  },
];
...
const TAG_COLORS: Record<string, string> = {
  ...
  "Fan Favorite": "bg-rose-700 text-white",
...
export default function App() {
  ...
  async function placeOrder() {
    ...
    const orderLines = cart
      .map((i) => `• ${i.name} × ${i.qty} — ${i.price * i.qty} EGP`)
      .join("\n");
  ...
  if (page === "confirmation") {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 py-20" style={{ background: "linear-gradient(135deg, #2C1007 0%, #6B3A2A 100%)" }}>
        <div className="text-center max-w-md w-full">
          <div className="text-8xl mb-6">🍪</div>
          <h1 className="font-display text-5xl font-bold text-amber-300 mb-4">Order Placed!</h1>
          ...
          <p className="text-amber-200/70 text-sm mb-8">We'll confirm your order shortly. Expect delivery within 2–3 hours.</p>
    ...
    return (
      <div className="min-h-screen" style={{ background: "#FDF6EC" }}>
        <header className="sticky top-0 z-50 bg-stone-900 px-6 py-4 flex items-center gap-4">
          ...
          <span className="font-script text-2xl text-amber-300 ml-auto">YAKAMOZ</span>
        </header>

        <div className="max-w-2xl mx-auto px-6 py-12">
          <h1 className="font-display text-4xl font-bold text-stone-900 mb-2">Checkout</h1>
          <p className="text-stone-500 mb-10">Fill in your details and we'll bring the treats to you.</p>
            ...
            <div className="bg-white rounded-2xl p-6 border border-stone-200 space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-700 mb-1">
                  ...
                  <span className="ml-2 text-xs font-normal text-stone-400">confirmation will be sent here</span>
                </label>
                <input
                  type="email"
                  value={email}
            ...
            <div className="bg-white rounded-2xl p-6 border border-stone-200">
              ...
              {payment === "instapay" && (
                <div className="mt-4 bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
                  ...
                  <p>Transfer to: <span className="font-bold">01012345678</span> (YAKAMOZ)</p>
  ...
  return (
    <div className="min-h-screen" style={{ background: "#FDF6EC" }}>
      <header className="sticky top-0 z-50 bg-stone-900/95 backdrop-blur-sm px-6 py-4 flex items-center justify-between">
        <div>
          <span className="font-script text-3xl text-amber-300">YAKAMOZ</span>
          <p className="text-stone-400 text-xs hidden sm:block">Artisan Cookies & Brownies</p>
        </div>
        <button
      ...
      {/* Hero */}
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, #2C1007 0%, #6B3A2A 60%, #8B5E3C 100%)" }}>
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-40 h-40 rounded-full" style={{ background: "#C47A2B", filter: "blur(60px)" }} />
          <div className="absolute bottom-10 right-20 w-60 h-60 rounded-full" style={{ background: "#D4A843", filter: "blur(80px)" }} />
        </div>
        <div className="relative max-w-6xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="font-script text-2xl text-amber-300 mb-4">Baked with love, daily</p>
            <h1 className="font-display text-6xl lg:text-7xl font-black text-white leading-tight mb-6">
              Cookies.<br />
              <span className="text-amber-300">Brownies.</span><br />
              Happiness.
            </h1>
            <p className="text-stone-300 text-lg leading-relaxed mb-8 max-w-md">
              Handcrafted in small batches using premium ingredients. Every bite is a moment worth savoring.
            </p>
            <button
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-2">
            <img src="https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=300&h=300&fit=crop&auto=format" alt="Chocolate chip cookies" className="rounded-2xl object-cover w-full aspect-square shadow-2xl" />
            <img src="https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=300&h=300&fit=crop&auto=format" alt="Fudge brownies" className="rounded-2xl object-cover w-full aspect-square shadow-2xl mt-8" />
          </div>
        </div>
      ...
      <div className="bg-amber-600 text-white">
        <div className="max-w-5xl mx-auto px-6 py-4 flex flex-wrap justify-center gap-x-10 gap-y-2 text-sm font-semibold">
          <span className="flex items-center gap-2">🧁 Baked fresh daily</span>
          <span className="flex items-center gap-2">🚚 Same-day delivery</span>
          <span className="flex items-center gap-2">💯 100% homemade</span>
          <span className="flex items-center gap-2">📦 Beautifully packaged</span>
        </div>
      </div>
            ...
            return (
              <div key={product.id} className="group bg-white rounded-3xl overflow-hidden border border-stone-100 hover:border-amber-200 hover:shadow-xl transition-all duration-300 flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <p className="text-stone-500 text-xs leading-relaxed flex-1 mb-4">{product.description}</p>
                  <div className="flex items-center justify-between">
                    <span className="font-display font-bold text-xl text-amber-700">{product.price} <span className="text-sm font-normal text-stone-500">EGP</span></span>
                    <button
      ...
      <footer className="bg-stone-900 text-stone-400 py-10 px-6 text-center">
        <p className="font-script text-3xl text-amber-300 mb-2">YAKAMOZ</p>
        <p className="text-sm">Handcrafted cookies & brownies — Cairo, Egypt</p>
        <p className="text-xs mt-4 text-stone-600">© 2026 YAKAMOZ. Made with butter and love.</p>
      </footer>
    </div>
  );
}
